...
<body class="animsition">
                                          ...
                                          <header class="header-desktop">
                                            <div class="section__content section__content--p30">
                                              <div class="container-fluid">
                                                ...
                                                <div class="modal fade" id="modal-large-1" tabindex="-1" role="dialog" aria-labelledby="#modal-large-1" aria-hidden="true">
                                                  <div class="modal-dialog modal-lg" role="document">
                                                  </div>
                                                </div>
                                                <div class="modal fade" id="modal-large-2" tabindex="-1" role="dialog" aria-labelledby="modal-large-2" aria-hidden="true">
                                                  <div class="modal-dialog modal-lg" role="document">
                                                  </div>
                                                </div>
  ...
  alert("Yeah! UI");
        ...
        alert("No esta JQuery UI cargado - JQuery UI is not loaded");
    }
  }
//}
                                            </script>
